...
export const Card = (props : cardProps) => {
    ...
    return(
        ...
        {
            domELementBackdrop 
            ? ReactDOM.createPortal(<React.StrictMode><Backdrop onClose={props.onClose} /></React.StrictMode>,domELementBackdrop) : null
        }
        {
            domELementOverlay 
            ? ReactDOM.createPortal(<React.StrictMode>
                <ModalOverlay zIndex={20}>{props.children}</ModalOverlay>
            </React.StrictMode>,domELementOverlay) : null
        }
        </React.Fragment>
    )
}